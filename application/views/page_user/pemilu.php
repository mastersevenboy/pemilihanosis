...
<section class="content">
            	...
            	<div class="col-xs-12 col-sm-4">
                    <div class="card profile-card">
                        ...
                        <center>
                            ...
                            <button type="button" class="btn btn-primary btn-circle waves-effect waves-circle waves-float" title="Pilih Kandidat" data-toggle="modal" data-target="#modal_konfirmasi<?php echo $row->nis_kandidat;?>">
    ...
    <!-- modal_konfirmasi -->
     <?php foreach($isi as $row) { ?>
      <div class="modal fade" id="modal_konfirmasi<?php echo $row->nis_kandidat;?>" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="<?php echo base_url(); ?>pemilu/Pemilihan/suara" method="POST" id="form_validation">

                        <div class="modal-header">
                            <h4 class="modal-title" id="defaultModalLabel">Konfirmasi Memilih Kandidat</h4>
                        </div>
                        <div class="modal-body">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                        	...
                        	<div class="modal-footer">
                            <button type="submit" class="btn btn-link waves-effect">Pilih</button>
