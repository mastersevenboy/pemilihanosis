<html>
<head>
	<title>Cetak Laporan Perolehan Suara</title>
	<style>
		table {
...
<body>
	...
	<br>
	<tr><div align="center">
		<img height="150px" width="150px" alt="<?= $row->foto; ?>" src="<?= base_url(); ?>./assets/images/<?= $row->foto; ?>">
	</div><br>
	<br>
	<tr class="bg-green">
    <th>NIS</th>
    ...
    <td align="center"><?php echo $row->suara_kandidat; ?></td>                                       
	</tr>
