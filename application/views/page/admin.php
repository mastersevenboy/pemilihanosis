...
<section class="content">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                	<div class="info-box bg-pink">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0" data-to="<?php echo $row->totaladmin; ?>" data-speed="1000" data-fresh-interval="20"></div>
                            <?php } ?>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-indigo">
                        ...
                        <div class="content">
                            <div class="text">Admin Aktif</div>

                            <?php foreach ($dataadminaktif as $row ) { ?>
                            <div class="number count-to" data-from="0" data-to="<?php echo $row->totaladminaktif; ?>" data-speed="1000" data-fresh-interval="20"></div>
                            <?php } ?>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-red">
                        ...
                        <div class="content">
                            <div class="text">Admin Non Aktif</div>
                            <?php foreach ($dataadmintidakaktif as $row ) { ?>
                            <div class="number count-to" data-from="0" data-to="<?php echo $row->totaladmintidakaktif; ?>" data-speed="1000" data-fresh-interval="20"></div>
                            <?php } ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal fade" id="tambahmodal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="<?php echo base_url(); ?>Admin/simpan" method="POST" id="form_validation">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="" method="POST" id="form_validation">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title" id="defaultModalLabel">View Data User</h4>
                        </div>
                        <div class="modal-body">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
        ...
        <div class="modal fade" id="editmodal<?php echo $row->nis;?>" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="<?php echo base_url();?>Admin/update/<?php echo $row->nis;?>" method="POST" id="form_validation"">
        ...
        <div class="modal fade" id="hapusmodal<?php echo $row->nis;?>" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <form action="<?php echo base_url();?>Admin/delete/<?php echo $row->nis;?>" method="POST">
                        <div class="modal-header">
